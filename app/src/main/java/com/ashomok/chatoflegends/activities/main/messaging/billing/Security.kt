package com.ashomok.chatoflegends.activities.main.messaging.billing
...
internal object Security {
     ...
     */
    private const val BASE_64_ENCODED_PUBLIC_KEY: String = BuildConfig.BASE_64_ENCODED_PUBLIC_KEY
    ...
    fun verifyPurchase(signedData: String, signature: String?): Boolean {
        if (TextUtils.isEmpty(signedData) || TextUtils.isEmpty(
        ...
        return try {
            ...
            LogHelper.e(TAG, "Error generating PublicKey from encoded key: " + e.message)
            false
        }
    }
    ...
    private fun verify(publicKey: PublicKey, signedData: String, signature: String?): Boolean {
        ...
        try {
            ...
            LogHelper.e(TAG, "Invalid key specification.")
        } catch (e: SignatureException) {
            LogHelper.e(TAG, "Signature exception.")
        }
        return false
    }
}