...
open class BaseHolder(val context: Context, itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    var selectedItems: LiveData<List<com.ashomok.chatoflegends.model.realms.Message>>? = null
    open fun bind(
        ...
        val progressIdleIconRes =
            if (com.ashomok.chatoflegends.model.constants.MessageType.isSentType(message.type)) R.drawable.ic_file_upload else R.drawable.ic_file_download
